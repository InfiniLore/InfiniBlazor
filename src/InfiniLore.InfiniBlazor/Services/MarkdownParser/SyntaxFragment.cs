...
// Code
// ---------------------------------------------------------------------------------------------------------------------
public class SyntaxFragment : ISyntaxFragment, IResettable {
    private IMdSyntaxNode? ParentNode { get; set; }
    private IMdSyntaxNode? ChildNode { get; set; }
    private HandlerOrigin HandlerOrigin { get; set; }
    ...
    // Methods
    // -----------------------------------------------------------------------------------------------------------------
    public void AsUnhandledMatch(Match match, IMdSyntaxNode node, HandlerOrigin origin) {
        ParentNode = node;
    ...
    public bool TryGetAsMatch([NotNullWhen(true)] out Match? match, [NotNullWhen(true)] out IMdSyntaxNode? parentNode, out HandlerOrigin origin) {
        match = Match;
        parentNode = ParentNode;
    ...
    public bool TryReset() {
        ParentNode = null;
        ChildNode = null;
        HandlerOrigin = HandlerOrigin.Undefined;
        Match = null;

...
// Code
// ---------------------------------------------------------------------------------------------------------------------
[InjectableSingleton<IMdSyntaxHandler>(MdRegexGroupNames.Underline)]
public sealed class UnderlineSyntaxHandler : IMdSyntaxHandler {
    private static readonly int UId = MdRegexLib.GetGroupId(MdRegexGroupNames.U);

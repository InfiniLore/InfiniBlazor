...
public partial record EmptyCssData : ICssData {
    ...
    public string NavHamburger { get; init; } = string.Empty;
    public string Nav { get; init; } = string.Empty;
    public string NavHorizontal { get; init; } = string.Empty;
    public string NavVertical { get; init; } = string.Empty;
    public string NavLeft { get; init; } = string.Empty;
    public string NavRight { get; init; } = string.Empty;
    public string NavBottom { get; init; } = string.Empty;
    public string NavTop { get; init; } = string.Empty;
    public string NavBorder { get; init; } = string.Empty;
    public string NavButton { get; init; } = string.Empty;
    public string NavButtonHover { get; init; } = string.Empty;
    public string NavHover { get; init; } = string.Empty;
    public string NavText { get; init; } = string.Empty;
    public string NavTextHover { get; init; } = string.Empty;

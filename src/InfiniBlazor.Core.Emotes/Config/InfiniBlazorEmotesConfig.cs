...
public class InfiniBlazorEmotesConfig : IEmotesConfig {
    private List<string> EmoteJsonLibFiles { get; } = [
        "/_content/InfiniBlazor.Emotes/emotes_standard.json",
        "/_content/InfiniBlazor.Emotes/emotes_standard_extended.json",
        "/_content/InfiniBlazor.Emotes/emotes_lucide.json",
        "/_content/InfiniBlazor.Emotes/emotes_duckies.json",
    ];
    ...
    // Constructors 
    // -----------------------------------------------------------------------------------------------------------------
    public InfiniBlazorEmotesConfig(IServiceCollection serviceCollection) {
        serviceCollection.RegisterServicesFromInfiniBlazorCoreEmotes();
        serviceCollection.AddSingleton<IEmotesConfig>(this);
    ...
    // Methods
    // -----------------------------------------------------------------------------------------------------------------
    public InfiniBlazorEmotesConfig AddEmbeddedResourceAssembly<TEntrypoint>() {

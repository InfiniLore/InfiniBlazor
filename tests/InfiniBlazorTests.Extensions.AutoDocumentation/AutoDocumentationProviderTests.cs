...
using InfiniBlazorTests.Extensions.AutoDocumentation.DataSources;
using InfiniBlazorTests.Extensions.AutoDocumentation.DataSources.CodeFiles;
using InfiniBlazorTests.Extensions.AutoDocumentation.DataSources.Components;

namespace InfiniBlazorTests.Extensions.AutoDocumentation;
// ---------------------------------------------------------------------------------------------------------------------
// Code
// ---------------------------------------------------------------------------------------------------------------------
public class AutoDocumentationProviderTests {
    public AutoDocumentationProvider Provider { get; } = new([new AutoDocumenterData_InfiniBlazorTestsExtensionsAutoDocumentation()]);

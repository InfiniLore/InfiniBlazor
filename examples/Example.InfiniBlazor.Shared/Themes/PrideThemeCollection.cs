...
public class PrideThemeCollection : ThemeCollection {
    ...
    protected override OrderedDictionary<ThemeMode, ICssData> Modes { get; } = new() {
        ...
        [Aromantic] = new EmptyCssData {
            ...
            SidebarNav = "linear-gradient(to bottom, rgb(60, 170, 65), rgb(179, 207, 164), rgb(255, 255, 255) 45%, rgb(255, 255, 255), rgb(255, 255, 255) 55%, rgb(128, 128, 128), rgb(0, 0, 0))",
            SidebarHamburger = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
            SidebarNavText = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
            SidebarNavTextHover = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
        },
        ...
        [Asexual] = new EmptyCssData {
            ...
            SidebarNav = "linear-gradient(to bottom, rgb(0, 0, 0), rgb(81, 81, 80), rgb(163, 162, 160), rgb(209, 208, 208), rgb(255, 255, 255) 60%, rgb(255, 255, 255), rgb(255, 255, 255) 70%, rgb(185, 151, 185), rgb(101, 46, 129))",
            SidebarHamburger = $"var({InfiniBlazorCssDataVariableNames.ColorBase00})",
            SidebarNavText = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
            SidebarNavTextHover = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
        },

...
public class PrideThemeCollection : ThemeCollection {
    ...
    protected override OrderedDictionary<ThemeMode, ICssData> Modes { get; } = new() {
        [Trans] = new EmptyCssData {
            ...
            NavHamburger = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
            NavText = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
            NavTextHover = $"var({InfiniBlazorCssDataVariableNames.ColorBase95})",
        },
        ...
        [Pride] = new EmptyCssData {
            ...
            NavHamburger = $"var({InfiniBlazorCssDataVariableNames.ColorBase00})",
            NavText = $"var({InfiniBlazorCssDataVariableNames.ColorBase00})",
            NavTextHover = $"var({InfiniBlazorCssDataVariableNames.ColorBase00})",
        },
